...
#define YOUR_EXTERNAL_RECORD_EXTENSION @"desktopshelf"
...
- (NSString *)applicationSupportDirectory {
    ...
    return [basePath stringByAppendingPathComponent:@"DesktopShelf"];
}

/**
    Returns the external records directory for the application.
	This code uses a directory named "DesktopShelf" for the content, 
...
- (NSString *)externalRecordsDirectory {
    ...
    NSString *basePath = ([paths count] > 0) ? [paths objectAtIndex:0] : NSTemporaryDirectory();
    return [basePath stringByAppendingPathComponent:@"Metadata/CoreData/DesktopShelf"];
}
